...
called pudb_stringifier() at the module level.  pudb_stringifier(value) should
return a string value for an valueect (note that str() will always be called on
