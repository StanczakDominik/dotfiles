...
_G.packer_plugins = {
  ["gitsigns.nvim"] = {
    ...
    loaded = true,
    path = "/home/dominik/.local/share/nvim/site/pack/packer/start/gitsigns.nvim",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/home/dominik/.local/share/nvim/site/pack/packer/start/onedark.vim",
  ...
  ["trouble.nvim"] = {
    ...
    loaded = true,
    path = "/home/dominik/.local/share/nvim/site/pack/packer/start/trouble.nvim",
